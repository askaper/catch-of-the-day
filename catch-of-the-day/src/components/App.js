  ...
  render() {
    return (
      <div className="catch-of-the-day">
        ...
        <Inventory updateFish={this.updateFish} fishes={this.state.fishes} addFish={this.addFish} loadSamples={this.loadSamples} /> {/*this is how we pass props to child components */}
      </div>
    )
  }
}
